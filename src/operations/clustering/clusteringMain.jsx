    ...
    const handleCreateFlow = () => {
        if (flowDiscription == '' || flowName == '') {
            ...
            if (getadmin() === 'true') {
                ...
                api.post('/clustering/clustering_add_flow_for_admin', values)
                    .then((res) => {
                        console.log(res)
                        dispatch(adddata(res.data))
                        setOpen(false)
                        navigate('/Clustering_Result')
                    })
                    .then((err) => {
                        console.log(err)
                    })
                ...
                api.post('/clustering/clustering_add_flow_for_user', values)
                    .then((res) => {
                        console.log(res)
                        dispatch(adddata(res.data))
                        setOpen(false)
